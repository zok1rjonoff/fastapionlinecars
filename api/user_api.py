...
def registration(user_name,user_phone_number,password):
    phone_number = check_phone_number(user_phone_number)
    print(f"{phone_number} =================================================")
    if phone_number == True:
        reg_user = registration_db(user_name,user_phone_number,password)
